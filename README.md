...
####1.1 东京大学人机交互研究室
东京大学人机交互实验室又叫[暦本研究室](http://lab.rekimoto.org/)，以实验室主任暦本纯一教授（Jun Rekimoto）的姓氏命名。目前，张鑫磊在这个实验室读研究生。有幸十一邀请他来我们实验室做报告，加上实验室网站是日语的，所以本部分基于他做报告的[ppt](https://github.com/jindongwang/HCI/blob/master/keynotes/RekimotoLab_ProjectList.pdf)，我只负责翻译与解释。实验室所有的项目在[这里](http://lab.rekimoto.org/projects/)。
